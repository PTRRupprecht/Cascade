...
4. Create a new Anaconda environment with the required packages: ``conda create -n Cascade python=3.6 tensorflow==2.1.0 keras==2.3.1 numpy scipy matplotlib seaborn ruamel.yaml spyder``. Other versions of python will work as well, we have mainly worked with Python 3.6 and 3.7, and versions of Tensorflow up to 2.3 so far.
